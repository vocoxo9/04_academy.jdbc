...
public class Member {
	...
	public Member(int memberNo, String memberId, String memberPwd, char gender, int age, String email, String address,
	...
	// 회원 추가 시 사용된 생성자
	public Member(String memberId, String memberPwd, char gender, int age) {
		this.memberId = memberId;
		this.memberPwd = memberPwd;
		this.gender = gender;
		this.age = age;
	...
	// 회원 정보 수정 시 사용된 생성자
	public Member(String memberId, String memberPwd, char gender, String address, String hobby) {
		super();
		this.memberId = memberId;
		this.memberPwd = memberPwd;
		this.gender = gender;
